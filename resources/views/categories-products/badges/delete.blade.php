    ...
    <div class="container-md">
        <div class="row justify-content-center">
            <div class="col-auto">
                <ul class="nav linkCrud">
                    ...
                    <li class="nav-item">
                        <a class="nav-link text-dark bg-orangeBrand" href="{{ url('badges/delete') }}">DELETE</a>
                    </li>
                </ul>
            </div>
        </div>
        ...
        <div class="row justify-content-center">
            ...
            <div class="col-md-6 p-5">
                ...
                <form method="POST" action="{{ url('/badges/delete') }}" enctype="multipart/form-data">
                    @csrf

                    <div class="form-group row">
                        <label for="badge" class="col-md-4 col-form-label text-md-right">
                            <strong>{{ __('Prodotto') }}</strong>
                        </label>

                        <div class="col-md-6">
                            <select id="badge" class="login-form-input border-dark form-control" name="badge">
