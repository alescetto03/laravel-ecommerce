    ...
    <div class="container-md">
        <div class="row justify-content-center">
            <div class="col-auto">
                <ul class="nav linkCrud">
                    ...
                    <li class="nav-item">
                        <a class="nav-link text-dark bg-orangeBrand" href="{{ url('categories/delete') }}">DELETE</a>
                    </li>
                </ul>
            </div>
        </div>
        ...
        <div class="row justify-content-center m-4">
            ...
            <div class="col-md-6 p-5">
                ...
                <form method="POST" action="{{ url('/categories/delete') }}" enctype="multipart/form-data">
                    @csrf
