        ...
        <div class="row justify-content-center">
            <div class="col-auto">
                <ul class="nav linkCrud">
                    ...
                    <li class="nav-item">
                        <a class="nav-link text-dark bg-orangeBrand" href="{{ url('order/delete') }}">DELETE</a>
                    </li>
                </ul>
            </div>
        </div>
            ...
            <div class="col-md-6 p-5">
                ...
                <form method="POST" action="{{ url('/order/delete') }}" enctype="multipart/form-data">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-md-6">
                            <select id="order" class="login-form-input border-0 form-control" name="order">
